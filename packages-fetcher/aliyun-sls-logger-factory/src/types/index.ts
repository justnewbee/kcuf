...
export type TFnOnBeforeSend = (options: ISlsFactoryOptions) => void | boolean;

export interface ISlsFlattenIgnore {
...
export interface ISlsFlattenOptions {
   ...
   */
  ignore?: string[] | ISlsFlattenIgnore;
}

export interface ISlsFactoryOptions {
  /**
 ...
 * sls 快捷方法额外参数
 */
export interface ISlsLogOptionsQuick {
  /**
 ...
 * sls log 方法额外参数
 */
export interface ISlsLogOptions extends ISlsLogOptionsQuick {
  group?: string;
}

export interface IFnLogQuick {
  (topic: string): void;
  (topic: string, info: undefined | null, options: ISlsLogOptionsQuick): void;
  <I>(topic: string, info: I, options?: ISlsLogOptionsQuick): void;
}

export interface ISlsLog {
  (topic: string): void;
  (topic: string, info: undefined | null, options: ISlsLogOptionsQuick): void;
  <I>(topic: string, info: I, options?: ISlsLogOptionsQuick): void;
  debug: IFnLogQuick;
...
export interface ISlsFactory {
  (options: ISlsFactoryOptions): ISlsLog;
}
