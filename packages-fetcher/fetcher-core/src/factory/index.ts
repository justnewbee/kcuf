 ...
 */
export default function createFetcher(fetcherAdapter: TFetcherAdapter, fetcherConfig?: IFetcherConfig): IFetcher {
  const fetcher = new Fetcher(fetcherAdapter, fetcherConfig);
