// https://vincentgarreau.com/particles.js/assets/_build/js/gui.js
// Generated by CoffeeScript 1.9.2
(function() {
  var id_presets = ['test', 'default', 'star', 'snow', 'bubble', 'nyancat', 'nyancat2', 'nasa'];
  var id_preset;
  ...
  if (!id_presets.includes(id_preset)) {
    id_preset = 'default';
  }
  ...
  $('#js-select-preset li').each(function(index) {
    var item = $('#js-select-preset li').eq(index);
  ...
  $('.js-dp-label').on('click', function() {
    var t = $(this);
    var id = $(this).attr('data-dp');
    var dropdown = $('.js-dp-dropdown[data-dp=' + id + ']');
  ...
  function konamiCode() {
    ...
    var n = 0;
    var pjs = $('#particles-js');
    var pjs_style = null;
    var playAudio = function() {
      var audio = document.createElement('audio');
      var src_path = window.location.origin + window.location.pathname + 'assets/medias/nyancat-loop.mp3';
  ...
  particlesJS.load('particles-js', 'assets/preset/' + id_preset + '.json', function() {
    return $(function() {
      window.loadGUI();
      window.loadStats();
      window.loadCodePen();
