...
describe('angleFromSegmentToSegment(segment1: Segment, segment2: Segment, undirected?: boolean): number', () => {
  test('0°', () => {
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[0, 0], [2, 0]])).toBe(0);
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[1, 1], [4, 1]])).toBe(0);
    
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[0, 0], [2, 0]], true)).toBe(0);
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[1, 1], [4, 1]], true)).toBe(0);
  });
  ...
  test('45° (π/4)', () => {
    ...
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[0, 0], [1, 1]], true)).toBeCloseTo(Math.PI / 4);
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[1, 1], [4, 4]], true)).toBeCloseTo(Math.PI / 4);
  });
  ...
  test('90° (π/2)', () => {
    ...
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[0, 0], [0, 1]], true)).toBeCloseTo(Math.PI / 2);
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[1, 1], [1, 7]], true)).toBeCloseTo(Math.PI / 2);
    expect(angleFromSegmentToSegment([[0, 0], [1, 1]], [[1, 0], [0, 1]], true)).toBeCloseTo(Math.PI / 2);
  });
  ...
  test('135° (3π/4)', () => {
    ...
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[0, 0], [-1, 1]], true)).toBeCloseTo(3 * Math.PI / 4);
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[1, 1], [0, 2]], true)).toBeCloseTo(3 * Math.PI / 4);
  });
  ...
  test('180° (π)', () => {
    ...
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[2, 0], [0, 0]], true)).toBeCloseTo(Math.PI);
    expect(angleFromSegmentToSegment([[0, 0], [1, 1]], [[1, 2], [0, 1]], true)).toBeCloseTo(Math.PI);
  });
  ...
  test('225° (5π/4)', () => {
    ...
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[0, 0], [-1, -1]], true)).toBeCloseTo(3 * Math.PI / 4);
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[1, 2], [0, 1]], true)).toBeCloseTo(3 * Math.PI / 4);
  });
  ...
  test('270° (3π/2)', () => {
    ...
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[0, 0], [0, -1]], true)).toBeCloseTo(Math.PI / 2);
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[0, 2], [0, 1]], true)).toBeCloseTo(Math.PI / 2);
  });
  ...
  test('315° (7π/4)', () => {
    ...
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[0, 0], [1, -1]], true)).toBeCloseTo(Math.PI / 4);
    expect(angleFromSegmentToSegment([[0, 0], [1, 0]], [[2, 2], [3, 1]], true)).toBeCloseTo(Math.PI / 4);
  });
});