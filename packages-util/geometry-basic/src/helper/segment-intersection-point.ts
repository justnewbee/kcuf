 ...
 * 获取两根线段的相交点
 */
export default function segmentIntersectionPoint(segment1: TSegment, segment2: TSegment): TPoint | null {
  const [A1, B1, C1] = segmentLineCoefficients(segment1);
  const [A2, B2, C2] = segmentLineCoefficients(segment2);
