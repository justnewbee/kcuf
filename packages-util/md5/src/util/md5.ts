...
// The core
export default function md5(message: string | number[] | Uint8Array): string {
  ...
  const digestBytes = cryptWordsToBytes(cryptEndian([a, b, c, d]));
  
  return cryptBytesToHex(digestBytes);
}
