 ...
 */
export default function detectOtherOverlays(): boolean {
  if (document.querySelector('.ant-select-open')) {
    return true;
  }
  
  const fusionOverlaysOpened = document.querySelectorAll('.next-overlay-wrapper.opened');
