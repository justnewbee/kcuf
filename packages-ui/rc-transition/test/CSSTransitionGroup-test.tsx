...
import { hasClass } from '@kcuf/mere-dom';

import { TransitionCss } from '../src';
...
describe('CSSTransitionGroup', () => {
  ...
  test('should work with a null child', () => {
    render(<TransitionGroup>{[null]}</TransitionGroup>, container);
  });
  
  test('should work with a child which renders as null', () => {
  ...
  test('should transition from false to one', () => {
  ...
  test('should clear transition timeouts when unmounted', () => {
  ...
  test('should handle unmounted elements properly', () => {
  ...
  test('should work with custom component wrapper cloning children', () => {
