...
describe('TransitionCss', () => {
  test('should flush new props to the DOM before initiating a transition', (done) => {
  ...
  describe('entering', () => {
    test('should apply classes at each transition state', async () => {
      let count = 0;
      let done = false;
      const nodeRef = createRef();
    ...
    test('should apply custom classNames names', async () => {
      let count = 0;
      const nodeRef = createRef();
      const {
        setProps
  ...
  describe('appearing', () => {
    test('should apply appear classes at each transition state', async () => {
      let count = 0;
      const nodeRef = createRef();
    ...
    test('should lose the "*-appear-done" class after leaving and entering again', async () => {
      const nodeRef = createRef();
      let entered = false;
      let exited = false;
      const {
    ...
    test('should not add undefined when appearDone is not defined', async () => {
      const nodeRef = createRef();
      let done = false;
    ...
    test('should not be appearing in normal enter mode', async () => {
      let count = 0;
      const nodeRef = createRef();
    ...
    test('should not enter the transition states when appear=false', () => {
      const nodeRef = createRef();
  ...
  describe('exiting', () => {
    ...
    test('should support empty prefix', async () => {
      let count = 0;
  ...
  describe('reentering', () => {
    test('should remove dynamically applied classes', async () => {
      let count = 0;
      ...
      const {setProps} = render(<Test direction="down" text="foo" nodeRef={nodeRef.foo} />);
