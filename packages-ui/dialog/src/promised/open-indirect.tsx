 ...
 * ```
 */
export default function openIndirect<T = void, D extends object = Record<string, unknown>>(contentOrProps?: string | ReactElement | DialogProps<T, D>): IDialogIndirectPromise<T, D> {
  ...
  const promise = new Promise<T>((resolve, reject) => {
    ...
    renderDialog(dialogProps!); // eslint-disable-line @typescript-eslint/no-non-null-assertion
  });
