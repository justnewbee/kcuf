...
$.widget("ui.mouse", {
	...
	_mouseInit: function() {
		...
		this.element.bind("mousedown." + this.widgetName, function(event) {
			...
			if (_this._preventClickEvent) {
				_this._preventClickEvent = false;
	...
	_mouseDown: function(event) {
		...
		// however, in Safari, this causes select boxes not to be selectable anymore, so this fix is needed
