CodeMirror.defineMode("python", function(conf) {
	...
	var commontypes = [ "bool", "classmethod", "complex", "dict", "enumerate", "float", "frozenset", "int", "list", "object", "property", "reversed", "set", "slice", "staticmethod", "str", "super", "tuple", "type" ];
	var py2 = {
	...
	function tokenLexer(stream, state) {
		...
		if (current === "@") {
			...
			return (style === "variable" || current === "@staticmethod" || current === "@classmethod") ? "meta" : ERRORCLASS;
		}
