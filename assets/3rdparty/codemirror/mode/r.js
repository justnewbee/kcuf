CodeMirror.defineMode("r", function(config) {
	...
	var atoms = wordObj("NULL NA Inf NaN NA_integer_ NA_real_ NA_complex_ NA_character_"),
		builtins = wordObj("list quote bquote eval return call parse deparse"),
		keywords = wordObj("if else repeat while function for in next break"),
		blockkeywords = wordObj("if else repeat while function for"),
		opChars = /[+\-*\/^<>=!&|~$:]/,
		curPunc;
